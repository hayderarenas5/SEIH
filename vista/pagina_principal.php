        ...
        <div class="menu_bar">
            ...
            <nav class="menu_pc">
                <ul class="menu">
                    ...
                    <li><a href="../vista/proyectos.php"><i class="fas fa-bell"></i>Proyectos</a></li>
                    <li><a href="../vista/garantiaI.php"><i class="fas fa-server"></i>Servicios</a></li>
                    <li><a href="#footer"><i class="fas fa-address-card"></i>Contactos</a></li>
                </ul>
            </nav>
        <div class="ayuda">
            <a href="../vista/ayuda.php"><i class="fas fa-question"></i></a>
        </div>
    </header>
...
<div class="nota">
    ...
    <div class="content-all">
        <div class="content-carrousel">
            <figure><a href="../vista/InfoExtintores/index.html"><img src="imagenes/extintores/clasea.png" alt=""></a></figure>
            <figure><a href="../vista/InfoExtintores/index.html"><img src="imagenes/extintores/claseabc.jpg" alt=""></a></figure>
            <figure><a href="../vista/InfoExtintores/index.html"><img src="imagenes/extintores/claseb.png" alt=""></a></figure>
            <figure><a href="../vista/InfoExtintores/index.html"><img src="imagenes/extintores/clasebc.jpg" alt=""></a></figure>
            <figure><a href="../vista/InfoExtintores/index.html"><img src="imagenes/extintores/clased.jpg" alt=""></a></figure>
            <figure><a href="../vista/InfoExtintores/index.html"><img src="imagenes/extintores/clasek.jpg" alt=""></a></figure>
